  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        dropdown_root: cn(
          "relative cn-calendar-dropdown-root rounded-(--cell-radius) border border-input p-1 hover:bg-accent hover:text-accent-foreground flex items-center justify-center bg-transparent",
